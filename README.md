...
| [`article-html-to-ppt`](./Skills/article-html-to-ppt/) | MeowClaw PPTSmith v2.0.3：把文章、PRD、研究材料和技术方案转成低返工、可编辑、可验证的演示稿，提供五套基础视觉系统、双 Builder、复杂图解路由、分档生产与可信 QA。 | v2.0.3 |
